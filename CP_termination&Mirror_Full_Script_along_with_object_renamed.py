# Checkpoint Mirror & Termination with single line comment Full Script along with full discard function
# Script written by Johnwesly Full and Final working script. renamed object as well...
import requests
import urllib3
import getpass
import json
